                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('hospital.edit.store') }}" >
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-floating mb-3 visually-hidden">
                                            <input type="number" class="form-control" id="floatingInput" name="id"
                                               value="{{ $hospital->id }}" >
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="floatingSelect" name="hospital_id"
                                                ...
                                                @foreach ($hospital_types as $hospital_type)
                                                    ...
                                                    <option value="{{ $hospital_type->id }}" {{ $hospital_type->id == $hospital->hospital_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelectGrid" name="province_id"
                                                        ...
                                                        @foreach ($provinces as $province)
                                                            <option value="{{ $province->provincecode }}" {{ $province->provincecode == $hospital->province_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelectGrid" name="district_id"
                                                        ...
                                                        @foreach ($districts as $district)
                                                            <option value="{{ $district->districtcode }}" {{ $district->districtcode == $hospital->district_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelectGrid" name="sector_id"
                                                        ...
                                                        @foreach ($sectors as $sector)
                                                            <option value="{{ $sector->sectorcode }}" {{ $sector->sectorcode == $hospital->sector_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelectGrid" name="cell_id"
                                                        ...
                                                        @foreach ($cells as $cell)
                                                            <option value="{{ $cell->cellcode }}" {{ $cell->cellcode == $hospital->cell_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-floating">
                                            <textarea class="form-control"id="floatingTextarea2" name="description"
                                                style="height: 100px">{!! $hospital->description !!}</textarea>
