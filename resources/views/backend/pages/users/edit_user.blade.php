                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('dashboard.pages.user.update') }}"
...
<div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" name="username" class="form-control" id="inputEmail4" value="{{ $userData->username }}" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
                                        <label for="inputEmail4" class="form-label"> Phone </label>
                                        <input type="number" name="phone" class="form-control" id="inputEmail4" value="{{ $userData->phone }}" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-3">
